...
export class StreakController {
    ...
    private emitStreakActivated() {
        events.emit('StreakActivated', {
            value: this.streak.isStreakActivated,
        }); // Event for score multiplier. Enabled/ Disabled
    }
    ...
    private startTimer() {
        ...
        this.timer = setInterval(() => {
            ...
            if (
                this.streak.state === StreakState.Active &&
                this.streak.gauge < 50
            ) {
