...
export function QuestionAnswer({ questionManager }: QuestionAnswerProps) {
  ...
  const btnGreen: React.CSSProperties = {
    ...
    boxShadow: "0 8px 16px rgba(55, 255, 0, 0.5), 0 0 12px rgba(10, 224, 6, 0.6)",
  };
  ...
  const cardBase: React.CSSProperties = {
    ...
    background: "linear-gradient(180deg, rgba(15,15,30,0.9) 0%, rgba(30,30,60,0.9) 100%)",
  ...
  const halo = (color: "green" | "red" | "none"): React.CSSProperties => {
    if (color === "green")
      return { boxShadow: "0 0 18px rgba(16, 185, 129, 0.85), 0 20px 40px rgba(0,0,0,0.8)" };
    if (color === "red")
      return { boxShadow: "0 0 18px rgba(239, 68, 68, 0.85), 0 20px 40px rgba(0,0,0,0.8)" };
    return {};
  };

  const feedbackAnimClass =
    feedback === "incorrect" ? "qa-shake" : feedback === "correct" ? "qa-pulse" : "";
      ...
      >
        ...
        <div
          style={{
            ...
            fontWeight: 900,
            marginBottom: "0.5rem",
            textShadow: "0 0 6px #ff0, 0 0 12px #ff8000, 0 0 24px #ff4000, 0 0 36px #ff0000",
        ...
        >
          Type numbers with your keyboard • Press <b>Enter</b> to submit • Press <b>S</b> to skip
        </div>
      </form>
