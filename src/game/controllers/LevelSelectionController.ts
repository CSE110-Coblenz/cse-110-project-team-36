...
export class LevelSelectionController {
  ...
  getDifficultyColor(difficulty: QuestionDifficulty) {
    switch (difficulty) {
      case QuestionDifficulty.EASY: return "#4CAF50"
      case QuestionDifficulty.MEDIUM: return "#FF9800"
      case QuestionDifficulty.HARD: return "#F44336"
      default: return "#666"
    }
  }
  ...
  getTopicSymbol(topic: QuestionTopic) {
    switch (topic) {
      ...
      case QuestionTopic.MIXED: return "±×÷"
      default: return "?"
    }
  }
  ...
  getTopicName(topic: QuestionTopic) {
    switch (topic) {
      case QuestionTopic.ADDITION: return "Addition"
      case QuestionTopic.SUBTRACTION: return "Subtraction"
      case QuestionTopic.MULTIPLICATION: return "Multiplication"
      case QuestionTopic.DIVISION: return "Division"
      case QuestionTopic.MIXED: return "Mixed Operations"
      default: return "Unknown"
    }
  }
