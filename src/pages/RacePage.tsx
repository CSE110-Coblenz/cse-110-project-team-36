...
import { QuestionAnswer } from "../rendering/game/QuestionAnswer"; // This is the question answer component
...
export const RacePage: React.FC<{ onExit: () => void }> = ({ onExit }) => {
  ...
  useEffect(() => {
    ...
    const resize = new ResizeListener(containerRef.current, (w, h) =>
      setSize({ w, h })
    );
    resize.start();
